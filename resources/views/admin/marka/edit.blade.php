...
@section('page-title', 'Edit Data Marka Jalan')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title mb-0">Edit Data Marka Jalan</h3>
                ...
                <form action="{{ route('marka.update', $marka) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <!-- Error Messages -->
                                    ...
                                    <select name="jalan_id" id="jalan_id" 
                                        ...
                                        @foreach($jalans as $jalan)
                                            <option value="{{ $jalan->id }}" 
                                                {{ (old('jalan_id') ?? $marka->jalan_id) == $jalan->id ? 'selected' : '' }}>
                                                {{ $jalan->nama_jalan }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="jenis_marka" id="jenis_marka" 
                                           ...
                                           value="{{ old('jenis_marka') ?? $marka->jenis_marka }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="warna" id="warna" 
                                        ...
                                        <option value="Putih" 
                                            {{ (old('warna') ?? $marka->warna) == 'Putih' ? 'selected' : '' }}>Putih</option>
                                        <option value="Kuning" 
                                            {{ (old('warna') ?? $marka->warna) == 'Kuning' ? 'selected' : '' }}>Kuning</option>
                                    </select>
                                    @error('warna')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="kondisi" id="kondisi" 
                                        ...
                                        <option value="baik" 
                                            {{ (old('kondisi') ?? $marka->kondisi) == 'baik' ? 'selected' : '' }}>Baik</option>
                                        <option value="pudar" 
                                            {{ (old('kondisi') ?? $marka->kondisi) == 'pudar' ? 'selected' : '' }}>Pudar</option>
                                        <option value="hilang" 
                                            {{ (old('kondisi') ?? $marka->kondisi) == 'hilang' ? 'selected' : '' }}>Hilang</option>
                                    </select>
                                    @error('kondisi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="panjang_seharusnya" id="panjang_seharusnya" 
                                           ...
                                           value="{{ old('panjang_seharusnya') ?? $marka->panjang_seharusnya }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="panjang_terpasang" id="panjang_terpasang" 
                                           ...
                                           value="{{ old('panjang_terpasang') ?? $marka->panjang_terpasang }}" 
                                           step="0.1" min="0" placeholder="0.0" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="km_awal" id="km_awal" 
                                           ...
                                           value="{{ old('km_awal') ?? $marka->km_awal }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="km_akhir" id="km_akhir" 
                                           ...
                                           value="{{ old('km_akhir') ?? $marka->km_akhir }}" 
                                           step="0.001" placeholder="0.000" required>
                                    @error('km_akhir')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tanggal_pemasangan" id="tanggal_pemasangan" 
                                           ...
                                           value="{{ old('tanggal_pemasangan') ?? ($marka->tanggal_pemasangan ? $marka->tanggal_pemasangan->format('Y-m-d') : '') }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="keterangan" id="keterangan" 
                                              ...
                                              rows="3" placeholder="Keterangan tambahan (opsional)">{{ old('keterangan') ?? $marka->keterangan }}</textarea>
                                    @error('keterangan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="alert alert-info">
                            ...
                            {{ $marka->updated_at->format('d/m/Y H:i:s') }}
                        </div>
                    </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('marka.show', $marka) }}" class="btn btn-outline-info">
