...
@section('page-title', 'Tambah Data Guardrail')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title mb-0">Tambah Data Guardrail</h3>
            ...
            <form action="{{ route('guardrail.store') }}" method="POST">
                @csrf
                <div class="card-body">
                    <!-- Error Messages -->
                    @if($errors->any())
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="tipe_guardrail" id="tipe_guardrail" 
                                    ...
                                    @foreach($tipeGuardrail as $tipe)
                                        <option value="{{ $tipe }}" 
                                            {{ old('tipe_guardrail') == $tipe ? 'selected' : '' }}>
                                            {{ $tipe }}
                                        </option>
                                    @endforeach
                                </select>
